  ...
  return (
    <div className="relative inline-block text-left">
      <button
        ...
        className="px-3 py-2 font-bold text-sm border border-gray-300 rounded-md bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 flex items-center justify-between gap-2"
      >
